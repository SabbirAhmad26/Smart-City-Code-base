...
path = [(287, 326), (288, 288), (326, 288)]
pts = [(287, 326), (288, 288), (326, 288)]
...
for i in range(100):
    ...
    for j in range(len(formula[0])):
        if j != len(formula[0])-1:
            x += int(formula[0][j] * ((i/99)**(len(formula[0])-j)))
            y += int(formula[1][j] * ((i/99)**(len(formula[1])-j)))
        else:
            x += int(formula[0][j])
            y += int(formula[1][j])
    path.append((x,y)) 
...
while run:
    ...
    pygame.draw.circle(gameDisplay, (255, 255, 0), (313,289), 5)
    pygame.draw.circle(gameDisplay, (255, 100, 0), (322,318), 5)
